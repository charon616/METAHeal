...
Shader "Custom/CustomHand"
{
    Properties
    {
        ...
        _NoiseAmp("Noise Amplitude", Float) = 0.005
        _NoiseScale("Noise Scale", Float) = 22.0
        _NoiseSpeed("Noise Speed", Float) = 1.5
        _GlowStrength("Glow Strength", Range(0,2)) = 0.8
        _CyanColor("Cyan Color", Color) = (0.2, 0.8, 1.0, 1)
...
#include "CustomOculusHandFillCG.cginc"
            ENDCG
        }
